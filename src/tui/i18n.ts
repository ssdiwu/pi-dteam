...
const I18N_BUNDLES: I18nBundleV1[] = [
  {
    ...
    messages: {
      ...
      "dialog.count": "{count} 个 worker · {active} 个运行中",
      "dialog.noWorkers": "暂无 worker。请用 dteam 派发任务。",
      ...
      "dialog.none": "无",
      "dialog.controls.list": "↑/↓ 或 j/k 选择 · Enter 查看详情 · Esc 关闭",
      "dialog.controls.running": "s 接管 · c 取消（需确认） · Esc 返回",
      "dialog.controls.archive": "只读封存 · Esc 返回",
  ...
  },
  {
    ...
    messages: {
      ...
      "dialog.detailTitle": "dteam / {title}",
      "dialog.count": "{count} worker(s) · {active} active",
      "dialog.noWorkers": "No workers. Dispatch a worker with dteam.",
      ...
      "dialog.none": "none",
      "dialog.controls.list": "↑/↓ or j/k select · Enter details · Esc close",
      "dialog.controls.running": "s steer · c cancel (confirm) · Esc back",
      "dialog.controls.archive": "read-only archive · Esc back",
