...
| [0008](./0008-dteam重定位为模型分级路由执行层.md) | dteam 重定位为模型分级路由执行层 | dteam = 模型分级路由（主模型思考/路由/验收，小任务 fan-out 小模型批量做，同档候选自动、跨档主代理逐级）；推翻 0006/0007；T1/T2/T3 取代五角色；当时的单工具面已被 0013/0018 更新为四工具 |
